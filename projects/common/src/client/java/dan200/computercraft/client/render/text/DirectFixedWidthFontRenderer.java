...
public final class DirectFixedWidthFontRenderer {
    ...
    public interface QuadEmitter {
         ...
         */
        void quad(float x1, float y1, float x2, float y2, float z, int nativeColour, float u1, float v1, float u2, float v2);
    }
    ...
    static void quad(ByteBuffer buffer, float x1, float y1, float x2, float y2, float z, int nativeColour, float u1, float v1, float u2, float v2) {
