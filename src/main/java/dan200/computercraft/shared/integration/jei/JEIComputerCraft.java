...
public class JEIComputerCraft implements IModPlugin {
    ...
    public void onRuntimeAvailable(IJeiRuntime runtime) {
        ...
        runtime.getIngredientManager()
               .addIngredientsAtRuntime(VanillaTypes.ITEM, upgradeItems);

        // Hide treasure disks
        runtime.getIngredientManager()
               .removeIngredientsAtRuntime(VanillaTypes.ITEM, Collections.singletonList(new ItemStack(ComputerCraft.Items.treasureDisk)));
        ...
        if (category != null) {
            for (Object wrapper : registry.getRecipes(category)) {
                ...
                if (id.getNamespace()
                      .equals(ComputerCraft.MOD_ID) && (id.getPath()
                                                          .startsWith("generated/turtle_") || id.getPath()
                                                                                                .startsWith("generated/pocket_"))) {
