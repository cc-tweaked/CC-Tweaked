...
public class ItemPocketComputer extends Item implements IComputerItem, IMedia, IColouredItem {
    ...
    private static final ModelPredicateProvider COMPUTER_STATE = (stack, world, player) -> getState(stack).ordinal();
    private static final ModelPredicateProvider COMPUTER_COLOURED = (stack, world, player) -> IColouredItem.getColourBasic(stack) != -1 ? 1 : 0;
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity player, @Nonnull Hand hand) {
        ...
        if (!world.isClient) {
            ...
            if (!stop) {
                Containers.openPocketComputerGUI(player, hand);
            }
        }
