...
public class NamedBlockEntityType<T extends TileEntity> extends TileEntityType<T>
{
    ...
    private static class FixedPointSupplier<T extends TileEntity> implements Supplier<T>
    {
