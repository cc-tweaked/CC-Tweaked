...
public final class InventoryUtil {
     ...
     *
     * This is largely based on {@link net.minecraftforge.common.crafting.IngredientNBT#test(ItemStack)}. It is sufficient to ensure basic information (such
     * as enchantments) are the same, while not having to worry about capabilities.
     *
