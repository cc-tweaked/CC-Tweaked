...
public interface ItemStorage
{
    ...
    class InventoryWrapper implements ItemStorage
    {
        ...
        @Override
        public @Nonnull ItemStack take( int slot, int limit, @Nonnull ItemStack filter, boolean simulate )
        {
        ...
        @Override
        public @Nonnull ItemStack store( int slot, @Nonnull ItemStack stack, boolean simulate )
        {
