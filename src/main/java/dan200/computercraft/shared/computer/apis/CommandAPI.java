...
public class CommandAPI implements ILuaAPI {
    ...
    public Object[] callMethod(@Nonnull ILuaContext context, int method, @Nonnull Object[] arguments) throws LuaException, InterruptedException {
        ...
        case 2:
            ...
            return context.executeMainThreadTask(() -> {
                MinecraftServer server = this.m_computer.getWorld()
                                                        .getServer();
        ...
        case 3: // getBlockPosition
        {
            ...
            BlockPos pos = this.m_computer.getPos();
            return new Object[] {
                pos.getX(),
                pos.getY(),
                pos.getZ()
        ...
        case 4: {
            ...
            return context.executeMainThreadTask(() -> {
                ...
                World world = this.getWorldFromID(arguments, 6);
        ...
        case 5: {
            ...
            return context.executeMainThreadTask(() -> {
                // Get the details of the block
                World world = this.getWorldFromID(arguments, 3);
    ...
    private Object[] doCommand(String command) {
        ...
        TileCommandComputer.CommandReceiver receiver = this.m_computer.getReceiver();
        try {
            receiver.clearOutput();
            int result = commandManager.execute(this.m_computer.getSource(), command);
            return new Object[] {
                result > 0,
                receiver.copyOutput()
            };
    ...
    private World getWorldFromID(@Nonnull Object[] arguments, int index) throws LuaException {
        World world = null;
        final int dim = optInt(arguments,
                               index, this.m_computer.getWorld().dimension.getType()
                                                                          .getRawId());
        for (World w : this.m_computer.getWorld()
                                      .getServer()
                                      .getWorlds()) {
            if (w.getDimension()
                 .getType()
