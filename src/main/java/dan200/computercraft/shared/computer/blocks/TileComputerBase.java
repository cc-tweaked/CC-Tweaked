...
public abstract class TileComputerBase extends TileGeneric implements IComputerTile, Tickable, Nameable
{
    ...
    */
    ...
    public TextComponent getName()
    {
        ...
        return label == null ? getCachedState().getBlock().getTextComponent() : new StringTextComponent( label );
    }
    ...
    {
        String label = getLabel();
        return label == null ? null : new StringTextComponent( label );
    }
}
