...
public class TurtleSuckCommand implements ITurtleCommand {
    ...
    public TurtleCommandResult execute(@Nonnull ITurtleAccess turtle) {
        ...
        if (inventory != null) {
            ...
            ItemStack stack = InventoryUtil.takeItems(this.m_quantity, storage);
            if (stack.isEmpty()) {
            ...
            Box aabb = new Box(newPosition.getX(),
                               newPosition.getY(),
                               newPosition.getZ(),
                               newPosition.getX() + 1.0,
                               newPosition.getY() + 1.0,
                               newPosition.getZ() + 1.0);
