        ...
        if (this.m_proxy == null) {
            this.m_proxy = new ComputerProxy() {
                ...
                protected TileComputerBase getTile() {
                    return TurtleBrain.this.m_owner;
                }
            };
        }
        return this.m_proxy;
    ...
    */
    ...
    private void updateAnimation() {
        if (this.m_animation != TurtleAnimation.None) {
            ...
            if (world.isClient && this.m_animation == TurtleAnimation.MoveForward && this.m_animationProgress == 4) {
    ...
    public float getToolRenderAngle(TurtleSide side, float f) {
        return (side == TurtleSide.Left && this.m_animation == TurtleAnimation.SwingLeftTool) || (side == TurtleSide.Right && this.m_animation == TurtleAnimation.SwingRightTool) ? 45.0f * (float) Math.sin(
