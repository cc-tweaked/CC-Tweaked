...
public class TurtleMoveCommand implements ITurtleCommand {
    ...
    public TurtleCommandResult execute(@Nonnull ITurtleAccess turtle) {
        ...
        if (block != null && !oldWorld.isAir(newPosition) && !WorldUtil.isLiquidBlock(oldWorld, newPosition) && !state.getMaterial()
                                                                                                                      .isReplaceable()) {
        ...
        if (!oldWorld.doesNotCollide(aabb)) {
            ...
            for (Entity entity : list) {
                ...
                Box pushedBB = entityBB.offset(direction.getOffsetX(), direction.getOffsetY(), direction.getOffsetZ());
