...
public class TurtleShovel extends TurtleTool {
    ...
    public TurtleCommandResult useTool(@Nonnull ITurtleAccess turtle, @Nonnull TurtleSide side, @Nonnull TurtleVerb verb, @Nonnull Direction direction) {
        if (verb == TurtleVerb.Dig) {
            ItemStack shovel = this.m_item.copy();
    ...
    protected boolean canBreakBlock(BlockState state, World world, BlockPos pos, TurtlePlayer player) {
        ...
        return material == Material.SOIL || material == Material.AGGREGATE || material == Material.SNOW_LAYER || material == Material.ORGANIC_PRODUCT || material == Material.SNOW_BLOCK || material == Material.REPLACEABLE_PLANT || material == Material.PLANT || material == Material.CACTUS || material == Material.GOURD || material == Material.LEAVES;
