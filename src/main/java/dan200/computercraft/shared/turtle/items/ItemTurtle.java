...
import static dan200.computercraft.shared.turtle.core.TurtleBrain.NBT_FUEL;
import static dan200.computercraft.shared.turtle.core.TurtleBrain.NBT_LEFT_UPGRADE;
import static dan200.computercraft.shared.turtle.core.TurtleBrain.NBT_OVERLAY;
import static dan200.computercraft.shared.turtle.core.TurtleBrain.NBT_RIGHT_UPGRADE;
...
public class ItemTurtle extends ItemComputerBase implements ITurtleItem {
    ...
    public void appendStacks(@Nonnull ItemGroup group, @Nonnull DefaultedList<ItemStack> list) {
        ...
        for (ITurtleUpgrade upgrade : TurtleUpgrades.getVanillaUpgrades()) {
            if (!TurtleUpgrades.suitableForFamily(family, upgrade)) {
                continue;
            }

            list.add(this.create(-1, null, -1, null, upgrade, 0, null));
        }
    }
