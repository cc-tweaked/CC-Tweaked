...
public abstract class BlockGeneric extends Block implements BlockEntityProvider
{
    ...
    @Override
    @Deprecated
    public final void neighborUpdate( BlockState state, World world, BlockPos pos, Block neighbourBlock, BlockPos neighbourPos )
    {
        BlockEntity tile = world.getBlockEntity( pos );
    ...
    {
        BlockEntity tile = world.getBlockEntity( pos );
        if( tile instanceof TileGeneric ) ((TileGeneric) tile).onNeighbourBlockEntityChange( neighbour );
    }
    */
