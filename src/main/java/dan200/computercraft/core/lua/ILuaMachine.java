 ...
 *
 * This should provide implementations of {@link dan200.computercraft.api.lua.ILuaContext}, and the ability to convert {@link ILuaObject}s into something
 * the VM understands, as well as handling method calls.
 */
public interface ILuaMachine {
    /**
     * Inject an API into the global environment of this machine. This should construct an object, as it would for any {@link ILuaObject} and set it to all
     * names in {@link ILuaAPI#getNames()}.
     *
