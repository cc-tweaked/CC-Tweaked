...
public class RedstoneAPI implements ILuaAPI {
    ...
    public Object[] callMethod(@Nonnull ILuaContext context, int method, @Nonnull Object[] args) throws LuaException {
        ...
        case 1: {
            ...
            this.m_environment.setOutput(side, output ? 15 : 0);
            return null;
        }
        case 2: // getOutput
            return new Object[] {this.m_environment.getOutput(parseSide(args)) > 0};
        case 3: // getInput
            return new Object[] {this.m_environment.getInput(parseSide(args)) > 0};
        case 4: {
            // setBundledOutput
            ComputerSide side = parseSide(args);
            int output = getInt(args, 1);
            this.m_environment.setBundledOutput(side, output);
            return null;
        }
        case 5: // getBundledOutput
            return new Object[] {this.m_environment.getBundledOutput(parseSide(args))};
        case 6: // getBundledInput
            return new Object[] {this.m_environment.getBundledInput(parseSide(args))};
        case 7: {
            // testBundledInput
            ComputerSide side = parseSide(args);
            int mask = getInt(args, 1);
            int input = this.m_environment.getBundledInput(side);
        ...
        case 9: {
            ...
            this.m_environment.setOutput(side, output);
            return null;
        }
        case 10:
        case 11: // getAnalogOutput/getAnalogueOutput
            return new Object[] {this.m_environment.getOutput(parseSide(args))};
        case 12:
        case 13: // getAnalogInput/getAnalogueInput
            return new Object[] {this.m_environment.getInput(parseSide(args))};
        default:
            return null;
        }
    }
