...
public class TermAPI implements ILuaAPI {
    ...
    public TermAPI(IAPIEnvironment environment) {
        this.m_terminal = environment.getTerminal();
        this.m_environment = environment.getComputerEnvironment();
    }
    ...
    public Object[] callMethod(@Nonnull ILuaContext context, int method, @Nonnull Object[] args) throws LuaException {
        ...
        case 20: {
            ...
            if (args.length == 2) {
                ...
                setColour(this.m_terminal, colour, rgb[0], rgb[1], rgb[2]);
            } else {
                double r = getReal(args, 1);
                double g = getReal(args, 2);
                double b = getReal(args, 3);
                setColour(this.m_terminal, colour, r, g, b);
            }
            return null;
        }
        case 21:
        case 22: {
            ...
            synchronized (this.m_terminal) {
                if (this.m_terminal.getPalette() != null) {
                    return ArrayUtils.toObject(this.m_terminal.getPalette()
                                                              .getColour(colour));
                }
            }
            return null;
