        ...
        case 2: // read
            ...
            try {
                ...
                if (count < 0) {
                    ...
                    int read = this.m_reader.read(chars);
                    ...
                    int read = this.m_reader.read(buffer, 0, Math.min(buffer.length, count));
                    if (read < 0) {
                        return null;
                    }
                    ...
                    while (read >= BUFFER_SIZE && totalRead < count) {
                        read = this.m_reader.read(buffer, 0, Math.min(BUFFER_SIZE, count - totalRead));
                        if (read < 0) {
                            break;
                        }
