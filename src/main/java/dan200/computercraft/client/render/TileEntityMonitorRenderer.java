...
public class TileEntityMonitorRenderer extends BlockEntityRenderer<TileMonitor> {
    ...
    private static void renderMonitorAt(TileMonitor monitor, double posX, double posY, double posZ, float f, int i) {
        ...
        try {
            ...
            GlStateManager.translated(-0.5 + TileMonitor.RENDER_BORDER + TileMonitor.RENDER_MARGIN,
                ...
                if (terminal != null) {
                    ...
                    try {
                        ...
                        mc.getTextureManager()
                          .bindTextureInner(FixedWidthFontRenderer.BACKGROUND);
                        if (redraw) {
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    fontRenderer.drawStringBackgroundPart(0,
                                                                          0,
                        ...
                        if (redraw) {
                            ...
                            try {
                                // Lines
                                for (int y = 0; y < height; y++) {
                                    fontRenderer.drawStringTextPart(0,
                                                                    FixedWidthFontRenderer.FONT_HEIGHT * y,
                                                                    terminal.getLine(y),
                    ...
                    renderer.vertex(-TileMonitor.RENDER_MARGIN, TileMonitor.RENDER_MARGIN, 0.0D)
                            .texture(0.0, 0.0)
                            .color(r, g, b, 1.0f)
                            .next();
                    renderer.vertex(-TileMonitor.RENDER_MARGIN, -ySize - TileMonitor.RENDER_MARGIN, 0.0)
                            .texture(0.0, 1.0)
                            .color(r, g, b, 1.0f)
                            .next();
                    renderer.vertex(xSize + TileMonitor.RENDER_MARGIN, TileMonitor.RENDER_MARGIN, 0.0D)
                            .texture(1.0, 0.0)
                            .color(r, g, b, 1.0f)
                            .next();
                    renderer.vertex(xSize + TileMonitor.RENDER_MARGIN, -ySize - TileMonitor.RENDER_MARGIN, 0.0)
                            .texture(1.0, 1.0)
                            .color(r, g, b, 1.0f)
                            .next();
                    tessellator.draw();
            ...
            try {
                ...
                renderer.vertex(-TileMonitor.RENDER_MARGIN, TileMonitor.RENDER_MARGIN, 0.0)
                        .next();
                renderer.vertex(-TileMonitor.RENDER_MARGIN, -ySize - TileMonitor.RENDER_MARGIN, 0.0)
                        .next();
                renderer.vertex(xSize + TileMonitor.RENDER_MARGIN, TileMonitor.RENDER_MARGIN, 0.0)
                        .next();
                renderer.vertex(xSize + TileMonitor.RENDER_MARGIN, -ySize - TileMonitor.RENDER_MARGIN, 0.0)
                        .next();
                tessellator.draw();
