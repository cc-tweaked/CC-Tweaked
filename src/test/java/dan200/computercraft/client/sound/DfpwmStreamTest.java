...
public class DfpwmStreamTest
{
    ...
    public void testDecodesBytes()
    {
        ...
        ByteBuffer buffer = stream.read( 2048 + 1 );
        assertEquals( 2048, buffer.remaining(), "Must have read 1024 bytes" );
        ...
        {
            assertEquals( (short) (decoded[i] << 8), buffer.getShort(), "Bad element at " + i );
        }
