describe("The parallel library", function()
    describe("parallel.waitForAny", function()
        it("validates arguments", function()
            ...
            expect.error(parallel.waitForAny, function(), 2):eq("bad argument #2 (expected function, got number)")
        end)
    ...
    describe("parallel.waitForAll", function()
        it("validates arguments", function()
            ...
            expect.error(parallel.waitForAll, function(), 2):eq("bad argument #2 (expected function, got number)")
        end)
