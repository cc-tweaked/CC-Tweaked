describe("The paintutils library", function()
    ...
    describe("paintutils.parseTextImage", function()
        it("validates arguments", function()
            paintutils.parseTextImage("")
            expect.error(paintutils.parseTextImage, nil):eq("bad argument #1 (expected string, got nil)")
        end)
    end)

    describe("paintutils.loadTextImage", function()
        it("validates arguments", function()
            paintutils.loadTextImage("")
            expect.error(paintutils.loadTextImage, nil):eq("bad argument #1 (expected string, got nil)")
        end)
    end)

    describe("paintutils.drawTextImage", function()
        it("validates arguments", function()
            expect.error(paintutils.drawTextImage, nil):eq("bad argument #1 (expected table, got nil)")
            expect.error(paintutils.drawTextImage, {}, nil):eq("bad argument #2 (expected number, got nil)")
            expect.error(paintutils.drawTextImage, {}, 1, nil):eq("bad argument #3 (expected number, got nil)")
        end)
    end)
end)
