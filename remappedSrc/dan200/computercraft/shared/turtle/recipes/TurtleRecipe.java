...
public final class TurtleRecipe extends ComputerFamilyRecipe
{
    ...
    public static final RecipeSerializer<TurtleRecipe> SERIALIZER = new dan200.computercraft.shared.computer.recipe.ComputerFamilyRecipe.Serializer<TurtleRecipe>()
    {
        @Override
